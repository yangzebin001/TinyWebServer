...
public class Dispatcher {
    public void dispatch(String url, ApplicationContext appContext, HttpRequest req, HttpResponse resp){
        ...
        } catch (ClassNotFoundException | ServletException | IllegalAccessException | InstantiationException | IOException e) {
            e.printStackTrace();
        }
    }
}
